...
public class ToolCallBudget {
    ...
    private static final String CALL_COUNT_ATTRIBUTE = ToolCallBudget.class.getName() + ".callCount";

    private final int maxCallsPerRequest;

    public ToolCallBudget(@Value("${lab3.tools.max-calls-per-request:3}") int maxCallsPerRequest) {
